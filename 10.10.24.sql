...
-- Вывести имя фамилию и зарплату сотрудников которые получают больше 'Luis' 'Popp'.
...
from employees all_emp
join employees L_P
on all_emp.employee_id != L_P.employee_id
where L_P.first_name = 'Luis' and L_P.last_name = 'Popp' and all_emp.salary;

-- 2 Вариант. Вывести имя фамилию и зарплату сотрудников 
-- которые получают больше 'Luis' 'Popp'.
...
-- Вывести имя, фамилию и 
-- зарплату первых трех сотрудников которые зарабатывают меньше 'Adam' 'Fripp'.
...
limit 3;
    ...
    left join employees t2 -- manager
    on t1.manager_id = t2.employee_id
    where t2.employee_id is null;

-- Найти сотрубников которые работают в том же деппартаменте что 'Laura' 'Bissot'.
...
join employees t2
on t1.employee_id != t2.employee_id
where t2.first_name = 'Laura' and t2.last_name
= 'Bissot' and t1.department_id = t2.department_id;
