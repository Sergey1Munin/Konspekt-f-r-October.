...
select * from teacher2competencies;
...
join competencies_t3
on t2.competencies_id = t3.id;



-- Домашняя работа 12.09 / 21.09 
...
-- 6. Создать бд tasks и в этой базе создать таблицу Staff используя скрипт. https://github.com/annykh/genTech/blob/main/staff.txt
